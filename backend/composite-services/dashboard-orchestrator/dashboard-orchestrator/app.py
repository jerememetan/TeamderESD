...
def get_dashboard():
    ...
    weight_recommendations = _build_weight_recommendations(section_id, team_metrics, criteria)

    payload = _normalize_metrics_payload(section_id, team_metrics, section_metrics)
    payload["data"]["weight_recommendations"] = weight_recommendations
